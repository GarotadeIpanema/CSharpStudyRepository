...
namespace ModernUi
{
    public partial class CustomBorderRadiusPanel : Panel
    {
        private int _cornerRadius = 40;

        public CustomBorderRadiusPanel()
        {
            InitializeComponent();
        ...
        public void RoundBorderForm(Panel panel)
        {
            ...
            // graphicsPath.AddArc(Bounds.X + Bounds.Width, Bounds.Y + Bounds.Height, 1, 1, 0, 90);
